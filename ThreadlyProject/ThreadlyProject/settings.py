"""
Django settings for ThreadlyProject project.
...
SECRET_KEY = '-bb1i1ki7(dp1b-(x9asa*oa4r286ggl_d)%($05$r72=c6kd!'
...
ROOT_URLCONF = 'ThreadlyProject.urls'
...
WSGI_APPLICATION = 'ThreadlyProject.wsgi.application'
